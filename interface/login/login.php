      ...
      <div class="<?php echo $loginrow; ?>">
          ...
          <div class="<?php echo $logoarea; ?>">
            ...
            <div class="text-center login-title-label">
                ...
                <?php } ?>
            <p class="text-center lead font-weight-normal login-bg-text-color"><?php echo xlt('Welcome to BioSerenity Health Record and Medical Practice Management solution.'); ?></p>
